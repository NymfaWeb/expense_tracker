...
<template>
  <Card
    class="w-full bg-zinc-950/70 backdrop-blur-2xl border-white/20 shadow-2xl overflow-hidden relative"
  >
    <div
      class="absolute inset-0 bg-gradient-to-br from-[#2dd4bf]/10 to-[#2dd4bf]/5 pointer-events-none"
    ></div>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-5">
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            ...
            <a
              href="#"
              class="text-sm text-[#2dd4bf] hover:text-[#2dd4bf]/80 transition-colors font-medium"
              >Forgot password?</a
            >
          </div>
          <Input
        ...
        <div
          v-if="isError"
          class="text-sm text-destructive font-medium p-3 bg-destructive/10 rounded-md border border-destructive/20"
        >
        ...
        <Button
          type="submit"
          class="w-full bg-[#2dd4bf] hover:bg-[#2dd4bf]/90 text-black font-semibold transition-all shadow-[0_0_20px_rgba(45,212,191,0.3)] hover:shadow-[0_0_30px_rgba(45,212,191,0.5)] mt-4 h-11 text-base rounded-lg flex items-center justify-center"
          :disabled="isPending"
        >
          <Loader2 v-if="isPending" class="h-6 w-6 animate-spin" />
    ...
    <div class="border-t border-white/10 p-6 bg-black/40 text-center relative z-10">
      <p class="text-zinc-400">
        ...
        <a href="#" class="text-[#2dd4bf] hover:text-[#2dd4bf]/80 font-semibold transition-colors"
          >Create one</a
        >
      </p>
    </div>
